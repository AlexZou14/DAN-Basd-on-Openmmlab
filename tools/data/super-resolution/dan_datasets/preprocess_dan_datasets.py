...
import numpy as np
import torch
from mmedit.models.common.DANpreprocess import tensor2img, imresize, SRMDPreprocessing, img2tensor
import random
...
def generate_mod_LR_bic():
    ...
    pca_matrix = torch.load(
        "/home/lab216/Desktop/mmediting/tools/data/super-resolution/div2k/pca_matrix/pca_matrix_x2.pth", map_location=lambda storage, loc: storage
    )
